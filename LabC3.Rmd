---
title: "Lab C3: Visualising models, diagnostics and transformations"
graphics: yes
output:
...
6. You can also visualise the second linear model on the natural body weight scale by applying a transformation in the `visreg` command. Try the following:
